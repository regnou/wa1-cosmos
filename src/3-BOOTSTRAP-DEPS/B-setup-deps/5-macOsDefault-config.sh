#!/bin/sh
#@@@
#@@@ MAC CMD (Ax) https://github.com/rusty1s/dotfiles/blob/master/macos/defaults.sh
#@@@
...
# screenshot
defaults write com.apple.screencapture name "_"
defaults write com.apple.screencapture "include-date" 0
# repertoire capture
defaults write com.apple.screencapture location "$HOME/0HOME/DL/0IMG/" && killall SystemUIServer
